SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        if (realestate.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há agentes imobiliários disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (taxi.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há táxis disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (police.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há polícia disponível.</div></div>'
            $(".lawyers-list").append(element);
        }
        
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">INEM (' + ambulance.length + ')</h1>');
        ...
        if (ambulance.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há INEM disponível.</div></div>'
            $(".lawyers-list").append(element);
        }
    } else {
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Advogados (' + lawyers.length + ')</h1>');
            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Já estás ligado a uma chamada!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Esta pessoa já está numa chamada");
                }
            } else {
