...
-- Regista o comando /skin oficialmente
QBCore.Commands.Add('skin', 'Abrir Menu de Roupa Illenium (Admin)', {}, false, function(source, args)
    -- Manda o cliente abrir o menu (o mesmo evento que funcionou no fskin)
